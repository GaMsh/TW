...
const char HTTP_HEADER_END[] PROGMEM        = "</head><body><div style='text-align:left;display:inline-block;min-width:260px;'><h2>Самый Честный Прогноз</h2><div>Чтобы устройство заработало, необходимо подключиться к wifi-сети</div>";
...
const char HTTP_SCAN_LINK[] PROGMEM       = "<br/><div class=\"c\"><a href=\"/wifi\">Сканировать снова</a></div>";
const char HTTP_SAVED[] PROGMEM           = "<div>Данные сохранены<br />Подключаемся к сети...<br /><br />Если соединение не будет установлено, точка доступа будет создана вновь</div>";
